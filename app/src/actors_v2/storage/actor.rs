//! Storage Actor implementation - V2
//!
...
impl StorageActor {
    ...
    fn schedule_compaction(&mut self) {
        ...
        if self.last_maintenance.elapsed() > Duration::from_secs(3600) {
    ...
    pub fn get_pending_writes_count(&self) -> usize {
        self.pending_writes.len()
    }

    /// Report comprehensive metrics
    fn report_metrics(&self) {
        let _cache_stats = futures::executor::block_on(self.cache.get_stats());
